...
<section id="featured" style="text-align: center;">
    <div class="container-fluid py-5">
        <h4 id="featured_prod" class="card-title fontRubik fontSize-20 pb-3" style="color: dodgerblue;">Featured Products</h4>
        <div id="brands" class="button-group text-center">
            <button class="btn is-checked" style="color: crimson;">Brands</button>
            <?php foreach ($brands as $brand) { ?>
                <a class="btn" href="product.php?brand=<?php echo $brand['brand']; ?>" style="color:darkslateblue"><?php echo $brand['brand']; ?></a>
            <?php } ?>
        </div>
